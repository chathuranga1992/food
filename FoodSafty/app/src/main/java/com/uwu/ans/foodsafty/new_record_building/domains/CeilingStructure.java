...
public class CeilingStructure {
    ...
    public CeilingStructure(String mClean, String mNoAccumilation, String mNoContamination, String mSuitable, String mMarks, String mRemarks) {
        this.mClean = mClean;
